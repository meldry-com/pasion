...
This documentation is intended to give an overview of how the `palpo-auth-service` (MAS) works, both from an admin perspective and from a developer perspective.
...
A hosted version is available at <https://palpo-im.github.io/palpo-auth-service/>.

## How the documentation is organized

This documentation has four main sections:

- The [installation guide](./setup/) will guide you through the process of setting up the `palpo-auth-service` on your own infrastructure.
