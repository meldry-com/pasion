...
This documentation is intended to give an overview of how the `pasion` (Pasion) works, both from an admin perspective and from a developer perspective.
...
A hosted version is available at <https://palpo-im.github.io/pasion/>.

## How the documentation is organized

This documentation has four main sections:

- The [installation guide](./setup/) will guide you through the process of setting up the `pasion` on your own infrastructure.
...
- The developer documentation is intended for people who want to [contribute to the project](./development/contributing.md). Developers may also be interested in:
  - Technical documentation for individual crates: [`rustdoc`](./rustdoc/pasion_handlers/)
