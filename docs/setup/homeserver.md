...
It currently only supports [Synapse](https://github.com/palpo-im/synapse) version 1.136.0 or later.
...
The `secret` property must match in both the Synapse configuration and the Palpo Authentication Service configuration.
