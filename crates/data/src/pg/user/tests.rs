    ...
    let provider = repo
        ...
        .add(
            ...
            UpstreamOAuthProviderParams {
                ...
                token_endpoint_auth_method: pasion_data::UpstreamOAuthProviderTokenAuthMethod::None,
                ...
                claims_imports: pasion_data::UpstreamOAuthProviderClaimsImports::default(),
                authorization_endpoint_override: None,
                token_endpoint_override: None,
                userinfo_endpoint_override: None,
                jwks_uri_override: None,
                discovery_mode: pasion_data::UpstreamOAuthProviderDiscoveryMode::Disabled,
                pkce_mode: pasion_data::UpstreamOAuthProviderPkceMode::Disabled,
                response_mode: None,
