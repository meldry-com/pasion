...
use pasion_data::{AccessToken, Clock, RefreshToken, RefreshTokenState, Session, new_id};
...
#[async_trait]
impl pasion_data::oauth2::OAuth2RefreshTokenRepository for PgOAuth2RefreshTokenRepository<'_> {
