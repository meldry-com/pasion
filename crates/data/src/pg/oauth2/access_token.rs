...
use pasion_data::{AccessToken, AccessTokenState, Clock, Session, new_id};
...
#[async_trait]
impl pasion_data::oauth2::OAuth2AccessTokenRepository for PgOAuth2AccessTokenRepository<'_> {
