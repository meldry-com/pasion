...
pub async fn get(
    ...
    let prepared = match load_registration_finish_preparation(
        ...
        crate::account_registration::HomeserverCheckMode::Strict,
    ...
    .await
    {
        ...
        Err(LoadRegistrationFinishPreparationError::Eligibility { source, .. }) => match source {
            ...
            crate::account_registration::CheckRegistrationFinishEligibilityError::HomeserverUnavailable(error) => {
        ...
        Err(LoadRegistrationFinishPreparationError::Prepare {
            ...
            crate::account_registration::PrepareRegistrationCompletionError::EmailInUse(email) => {
