...
pub enum CheckError {
    ...
    #[error(
        "Guest support is enabled in the Synapse configuration. Guests aren't supported by MAS, but if you don't have any then you could disable the option. See https://github.com/palpo-im/palpo-auth-service/issues/1445"
    )]
    GuestsEnabled,
...
pub enum CheckWarning {
    ...
    #[error(
        "Synapse database contains {num_guests} guests which will be migrated are not supported by MAS. See https://github.com/palpo-im/palpo-auth-service/issues/1445"
    )]
